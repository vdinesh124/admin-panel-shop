...
export default function Landing({ redirectTo }: LandingProps) {
  ...
  const urlRedirect = typeof window !== "undefined"
    ...
    : null;
  const finalRedirect = redirectTo || urlRedirect;
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (finalRedirect && finalRedirect !== "/login") {
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-3">
                <input
                  ...
                  onFocus={(e) => { e.target.style.borderColor = "rgba(0, 220, 255, 0.4)"; e.target.style.boxShadow = "0 0 15px rgba(0, 220, 255, 0.08)"; }}
                  onBlur={(e) => { e.target.style.borderColor = "rgba(0, 220, 255, 0.12)"; e.target.style.boxShadow = "none"; }}
